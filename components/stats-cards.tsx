      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
          <Card className="bg-blue-50 border-blue-100 dark:bg-blue-950 dark:border-blue-900">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-blue-700 dark:text-blue-300">{stats.totalProductos}</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card className="bg-green-50 border-green-100 dark:bg-green-950 dark:border-green-900">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-green-700 dark:text-green-300">{stats.totalStock}</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card className="bg-red-50 border-red-100 dark:bg-red-950 dark:border-red-900">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-red-700 dark:text-red-300">{stats.stockBajo}</p>
            </CardContent>
          </Card>
        </motion.div>
      </div>
                ...
                <div className="flex-1 mx-2">
                  <div className="h-4 bg-muted rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${(item.cantidad / stats.totalProductos) * 100}%` }}
                    ></div>
                  </div>
                </div>
                <div className="w-10 text-right font-medium">{item.cantidad}</div>
              </motion.div>
            ))}
        </div>
      </div>
