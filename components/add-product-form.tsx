...
export default function AddProductForm({ onAddProduct, onCancel, categories, onAddCategory }) {
  // Form state
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center p-4 border-b">
        <h2 className="text-lg font-medium text-[#013612] dark:text-[#BFD189]">Agregar Nuevo Producto</h2>
      ...
      <form onSubmit={handleSubmit} className="p-4 space-y-4">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger className={`bg-background ${errors.categoria_id ? "border-red-500" : ""}`}>
        ...
        <div className="flex justify-end gap-2 pt-2">
          ...
          <Button type="submit" className="bg-[#52C1E4] hover:bg-[#3ba9cc] text-white">
            Agregar Producto
          </Button>
        </div>
      </form>
